...
export function useClassroomsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ClassroomsQuery,
    ClassroomsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ClassroomsQuery, ClassroomsQueryVariables>(
    ClassroomsDocument,
    options,
  )
}
export function useClassroomsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ClassroomsQuery, ClassroomsQueryVariables>(
    ClassroomsDocument,
    options,
  )
}
export type ClassroomsQueryHookResult = ReturnType<typeof useClassroomsQuery>
export type ClassroomsLazyQueryHookResult = ReturnType<
  typeof useClassroomsLazyQuery
>
export type ClassroomsQueryResult = Apollo.QueryResult<
  ClassroomsQuery,
  ClassroomsQueryVariables
>
